/* ===== ASED WEBSITE - OPTIMIZED JAVASCRIPT ===== */

// Performance optimization: Use const/let instead of var
...
/**
 * Animate number counters with performance optimization
 */
...
/**
 * Reveal elements on scroll with debouncing for performance
 */
function revealOnScroll() {
    const reveals = document.querySelectorAll('.fade-in-up, .card-animate, .hover-lift');
...
document.addEventListener('click', (e) => {
    ...
    if (href === '#' || link.classList.contains('nav-link')) {
        return;
    }
...
scrollTopButton.style.cssText = `
    ...
    height: 50px;
    border-radius: 50%;
    background: linear-gradient(135deg, #2d8659 0%, #1e5a3f 100%);
    color: white;
    border: none;
    cursor: pointer;
    font-size: 1.5rem;
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('%cASED Website Loaded', 'font-size: 16px; color: #2d8659; font-weight: bold;');
